...
import static f5.health.app.member.entity.vo.MemberCheckUp.DAILY_MAX_CIGARETTES;
import static f5.health.app.member.entity.vo.MemberCheckUp.DAILY_MAX_WATER_ML;
...
public record ActivityRequest(
        ...
        @Schema(description = "음주 관련 정보", requiredMode = NOT_REQUIRED) @NotNull(message = "음주 여부를 알려주세요.") @Valid AlcoholConsumptionInfo alcoholConsumptionInfo,
