...
public record ActivityRequest(
        @Schema(description = "음수량(ml)", example = "650", nullable = true) @Positive @Max(value = DAILY_MAX_WATER_ML, message = "하루에 기록 가능한 최대 음수량은 " + (DAILY_MAX_WATER_ML / 1000) + "리터입니다.") Integer waterIntake,
        @Schema(description = "흡연량(개비)", example = "6", nullable = true) @Positive @Max(value = DAILY_MAX_CIGARETTES, message = "하루에 기록 가능한 흡연량 최대치는 " + DAILY_MAX_CIGARETTES + "개비입니다.") Integer smokedCigarettes,
