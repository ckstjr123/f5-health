...
public record MemberUpdateRequest(
        ...
        @Schema(description = "키(cm)", example = "173", requiredMode = REQUIRED) @Height double height,
        @Schema(description = "몸무게(kg)", example = "65", requiredMode = REQUIRED) @Weight double weight) {
}
