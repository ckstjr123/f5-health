...
public class DeviceService {
    ...
    public Device registerDevice(Long memberId, DeviceInfo deviceInfo, JwtProvider.RefreshToken refreshToken) {
        ...
        return deviceRepository.save(Device.of(member, deviceInfo.getUdid(), deviceInfo.getOs(), refreshToken));
    }
