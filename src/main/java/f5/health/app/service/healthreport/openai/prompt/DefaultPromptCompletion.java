...
import static f5.health.app.service.healthreport.HealthReportService.MIN_SAVED_MONEY_REQUIRED;

public enum DefaultPromptCompletion {

    SAVED_MONEY_DEFAULT_COMPLETION(
            "\uD83D\uDCB0 총 절약 금액이 " +
                    NumberFormat.getNumberInstance(Locale.KOREA).format(MIN_SAVED_MONEY_REQUIRED) +
